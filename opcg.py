...
def character_generator(): 
 ...
 'Мастерский', 'Видение будущего'], 
 weights=(30, 25, 10, 5, 5)))[2:-2], 
 "\nУровень КВ:", str(random.choices(['Неосознанный', 'Осознанный'], weights=(20, 10)))[2:-2]) 
...
def arena_generator(): 
 print("Местность:", random.choice(['Пустыня', 'Снежная', 'Горы', 'Равнины', 'Лес', 'Море'])) 
